...
namespace CoverShooter
{
    ...
    public class AIFear : AIBase, IAlertListener
    {
        ...
        private List<BaseActor> _visibleFighters = new List<BaseActor>();
        ...
        private void Update()
        {
            ...
            var threatAsActor = _threat as Actor;

            if (_threat != null && (threatAsActor == null || threatAsActor.IsArmed) && !_wasThreatArmed)
            {
