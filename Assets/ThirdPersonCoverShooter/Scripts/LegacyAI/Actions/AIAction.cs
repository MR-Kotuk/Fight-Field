...
namespace CoverShooter
{
    ...
    public abstract class AIAction : ScriptableObject
    {
        ...
        protected BaseActor _targetActor;
        ...
        /// </summary>
        public bool Execute(Actor actor, BaseActor target)
        {
            _actor = actor;
            _targetActor = target;
        ...
        /// </summary>
        public virtual bool IsNeededFor(BaseActor target)
        {
            return false;
        }
        ...
        /// </summary>
        public virtual bool WillMoveForActor(BaseActor target)
        {
            return false;
        }
