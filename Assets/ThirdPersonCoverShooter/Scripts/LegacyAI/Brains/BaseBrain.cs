...
namespace CoverShooter
{
    ...
    {
        /// <summary>
        /// BaseActor component found in the same object.
        /// </summary>
        ...
        /// <summary>
        /// BaseActor component of the threating character.
        /// </summary>
        ...
        /// </summary>
        public BaseActor ForgottenThreat
        {
        ...
        private BaseActor _threat;
        private BaseActor _forgottenThreat;
        ...
        /// </summary>
        protected void SetUnseenThreat(bool isHeard, bool isDirect, BaseActor threat, Vector3 position, Cover threatCover)
        {
        ...
        /// </summary>
        protected void SetThreat(BaseActor threat, Vector3 position, Cover threatCover)
        {
        ...
        /// </summary>
        protected void SetThreat(bool isVisible, bool isHeard, bool isActual, BaseActor threat, Vector3 position, Cover threatCover, float time)
        {
