...
namespace CoverShooter
{
    ...
    public class SpawnGroup : MonoBehaviour
    {
        ...
        /// </summary>
        public void Spawn(BaseActor caller)
        {
        ...
        /// </summary>
        public IEnumerable<GameObject> SpawnAndReturn(int max, BaseActor caller, bool isForced = false)
        {
        ...
        /// </summary>
        public IEnumerable<GameObject> SpawnAndReturn(int max, GameObject[] prefabs, BaseActor caller, bool isForced = false)
        {
            if (Secondary != null && Random.Range(0f, 1f) <= SecondaryChance)
            {
