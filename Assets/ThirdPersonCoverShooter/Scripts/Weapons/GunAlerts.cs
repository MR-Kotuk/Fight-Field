...
namespace CoverShooter
{
    ...
    public class GunAlerts : MonoBehaviour, IGunListener
    {
        ...
        public void OnPump()
        {
            ...
            checkActor();
            Alerts.Broadcast(transform.position, Reload, AlertType.GunHandling, _actor, true);
        }
        ...
        public void OnFire(float delay)
        {
            ...
            checkActor();
            Alerts.Broadcast(transform.position, Fire, AlertType.GunHandling, _actor, true);
        }
        ...
        public void OnEmptyFire()
        {
            ...
            checkActor();
            Alerts.Broadcast(transform.position, EmptyFire, AlertType.GunHandling, _actor, true);
        }
        ...
        private void checkActor()
        {
            if (_gun.Character != _cachedMotor)
            {
                ...
                _actor = _cachedMotor.GetComponent<BaseActor>();
            }
        }
    }
}
