...
namespace CoverShooter
{
    ...
    public class AIActions : AIBase
    {
        ...
        private List<BaseActor> _possibleActionTargets = new List<BaseActor>();
        private List<BaseActor> _nearbyActors = new List<BaseActor>();
        ...
        /// </summary>
        public void Execute(AIAction action, BaseActor target)
        {
            if (_active != null || action.Wait > float.Epsilon)
                return;
        ...
        private void Update()
        {
                ...
                (!WaitForCoverActions || !_isTakingCover))
            {
                ...
                BaseActor bestSingleActionTarget = null;
