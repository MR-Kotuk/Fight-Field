...
namespace CoverShooter
{
    ...
    public class MeleeAlerts : MonoBehaviour, IMeleeListener
    {
        ...
        public void OnMeleeAttack()
        {
            ...
            checkActor();
            Alerts.Broadcast(transform.position, Attack, AlertType.Melee, _actor, true);
        }
        ...
        public void OnMeleeHit()
        {
            ...
            checkActor();
            Alerts.Broadcast(transform.position, Hit, AlertType.Melee, _actor, true);
        }
        ...
        public void OnMeleeMoment()
        {
            ...
            checkActor();
            Alerts.Broadcast(transform.position, Moment, AlertType.Melee, _actor, true);
        }
