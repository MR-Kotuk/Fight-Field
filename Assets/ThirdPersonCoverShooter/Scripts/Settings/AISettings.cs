...
namespace CoverShooter
{
    ...
    public struct AICall
    {
        ...
        /// <summary>
        /// Should the calling BaseActor component be passed to the called function as an argument.
        /// </summary>
        [Tooltip("Should the calling BaseActor component be passed to the called function as an argument.")]
        public bool PassCaller;

        public void Make(BaseActor caller)
        {
            if (Target != null)
            {
                if (PassCaller)
