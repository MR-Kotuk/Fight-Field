...
namespace CoverShooter
{
    ...
    public class AIThreatControl : AIBase
    {
        ...
        private BaseActor _threatOverride;
        ...
        /// </summary>
        public void ToOverrideThreat(BaseActor threat)
        {
        ...
        private void removeFromMemory(BaseActor actor)
        {
            for (int i = 0; i < _memory.Count; i++)
        ...
        private void addToMemory(BaseActor actor, Vector3 position)
        {
